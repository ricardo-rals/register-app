<div class="w-full bg-white shadow-md rounded px-8 py-12">
    ...
    <input type="text" name='phone_number' placeholder="Telefone:" value="{{ $user->phone_number ?? old('phone_number') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline my-2">
    <input type="date" name="birth_date" value="{{ $user->birth_date->format('Y-m-d') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline my-2">
